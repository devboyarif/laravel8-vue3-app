                        ...
                        <div class="divide-y-4">
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="text-truncate">
                                            <strong>Haskel Shelper</strong> change status of <strong>Zakir Soft
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="text-truncate">
                                            <strong>Lorry Mion</strong> liked <strong>Zakir Soft UI Kit</strong>.
                                        </div>
                                        <div class="text-muted">yesterday</div>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="text-truncate">
                                            <strong>Dyann Escala</strong> hosted the event <strong>Zakir Soft UI
                                                Birthday</strong>.
                                        </div>
                                        <div class="text-muted">4 days ago</div>
                                    </div>
...
export default {
    components: {},
    created() {
        let hasPermission = this.$store.getters['rolepermission/userHasPermission']('dashboard');
