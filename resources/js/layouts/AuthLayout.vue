<template>
    <div class="antialiased border-top-wide border-primary d-flex flex-column" style="min-height: 100vh">
        <div class="flex-fill d-flex flex-column justify-content-center py-4">
            <div class="container-tight py-6">
                <div class="text-center mb-4">
                    <router-link :to="{ name: 'home' }">
                        <svg xmlns="http://www.w3.org/2000/svg" height="36" viewBox="0 0 232 68">
